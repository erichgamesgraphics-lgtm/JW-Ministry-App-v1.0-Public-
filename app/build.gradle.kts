...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.ministrytracker.jwapp"
    minSdk = 23
    targetSdk = 34
    versionCode = 1
    versionName = "1.0"
  ...
  signingConfigs {
    create("release") {
      ...
      val dedicatedReleaseKeystore = file("${rootDir}/release.keystore")
      ...
      } else if (dedicatedReleaseKeystore.exists()) {
        storeFile = dedicatedReleaseKeystore
        storePassword = "androidrelease"
        keyAlias = "ministrytracker"
